...
export default function DriverWithdrawPage() {
  ...
  return (
    <DashboardLayout role="driver" pageTitle="Request Payout">
          ...
          {success && (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl border border-secondary/20 bg-gradient-to-br from-secondary/[0.08] via-dark-surface to-accent/[0.04] p-8 sm:p-12 text-center">
                ...
                <h2 className="text-2xl font-black text-white mb-2">Payout Requested!</h2>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Button href="/driver/earnings" variant="green" size="md">
                    <Wallet size={16} /> Back to Earnings
                  </Button>
                  <Button href="/driver/dashboard" variant="outline" size="md">
