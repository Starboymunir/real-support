        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-between p-12">
          ...
          <div className="absolute top-1/3 right-12 flex flex-col gap-4 z-30">
            <motion.div
              ...
              className="glass-dark rounded-2xl p-5 animate-float glow-green"
            >
          ...
          <div className="glass-dark rounded-3xl p-8 sm:p-10 neon-border">
            ...
            <div className="flex gap-3 mb-6">
              <motion.button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white text-gray-800 font-semibold text-sm hover:bg-gray-100 transition-all"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05, y: -2 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#1877F2] text-white font-semibold text-sm hover:bg-[#166FE5] transition-all"
              >
              ...
              <div className="flex gap-2">
                <motion.div whileHover={{ scale: 1.03 }} className="flex-1">
                  <Link
                    ...
                    className="block text-center py-2.5 px-3 rounded-lg bg-white/[0.04] text-white/50 text-xs font-medium hover:bg-secondary/10 hover:text-secondary transition-all border border-white/5"
                  >
                    Rider Dashboard
                  </Link>
                </motion.div>
