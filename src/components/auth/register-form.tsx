...
import { UserSchema, TUserCredentialsValidator } from '@/lib/validators/user-validation'
...
const RegisterForm = () => {
  ...
  const onSubmit = async ({
    ...
    const phone = phone_number.startsWith('+') ? formatedPhone : `+${formatedPhone}`
    try {
    ...
    <div className="md:py-8">
      <section className="max-w-173.25 mx-auto mt-5 bg-linear-to-b from-white/20 to-white/0 rounded-sm p-5 md:p-10">
        <div className="grid place-items-center gap-5">
          ...
          <p className=" text-primary font-poppins mb-5 text-4xl font-semibold ">Create Account</p>
          <SocialButton
            social="Google"
