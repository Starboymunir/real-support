...
const fallbackSections = [
  { title: '1. Acceptance of Terms', body: 'By accessing or using the RS Ride platform, you agree to be bound by these Terms of Service. If you do not agree, please do not use our services. RS Ride is operated by Professional Service Support Ltd.' },
  { title: '2. Service Description', body: 'RS Ride provides a technology platform connecting riders with licensed private hire drivers. We are a ride-sharing marketplace and do not provide transportation services directly. All drivers are independent contractors.' },
  ...
  { title: '6. User Conduct', body: 'Users must treat drivers with respect, refrain from illegal activities during rides, and comply with applicable laws. RS Ride reserves the right to suspend or terminate accounts that violate these terms.' },
  ...
  { title: '8. Limitation of Liability', body: 'RS Ride provides the platform "as is" and does not guarantee uninterrupted service. Our liability is limited to the fare paid for the relevant ride. We are not liable for indirect or consequential damages.' },
